...
public class Supplier {
    ...
    public Supplier(String name, String shortName, String fullName, String taxCode, Set<Invoice> invoices, Set<Address> addresses, Set<BankAccount> bankAccounts, String username) {
